...
namespace LostInSin.Runtime.Infrastructure.Data
{
	...
	public class ApplicationSettings : SerializedScriptableObject
	{
		...
		[TitleGroup("Scene Indexes")] public int FirstGameplayLevelIndex;
		public int LevelToLoopAfterAllLevelsFinishedIndex;
		[ShowIf("HasMainMenu")] public int MainMenuSceneIndex;

		[ShowIf("ShowLoadingScreen")] [TitleGroup("Loading Screen")] [ShowIf("ShowLoadingScreen")]
		public float LoadingScreenMinimumDuration = 0.5f;

		[ShowIf("ShowLoadingScreen")] public LoadingScreenView LoadingScreenPrefab;

		[TitleGroup("DOTween Settings")] public bool RecycleAllByDefault = false;
