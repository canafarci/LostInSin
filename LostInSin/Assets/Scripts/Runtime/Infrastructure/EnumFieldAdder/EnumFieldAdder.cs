...
namespace LostInSin.Runtime.Infrastructure.EnumFieldAdder
{
	[HideLabel]
	[HideReferenceObjectPicker]
	public class EnumFieldAdder<T>
	{
		[Title("Add New Field to Enum")] public string NewFieldName;
		...
		private List<string> GenerateUpdatedEnumContent(List<string> lines, List<string> desiredFields, int startIdx,
			int endIdx)
		{
