...
namespace LostInSin.Grid
{
    public class GridCellGenerator : IGridCellGenerator
    {
        ...
        public (GridCell[,], GridCellData[,]) GenerateGridCells(NativeArray<GridPoint> gridPoints)
        {
        ...
        {
            Vector3 rayOrigin = new Vector3(cell.Center.PosX, RAY_ORIGIN_HEIGHT, cell.Center.PosZ);
